...
def parse_args():
    ...
    parser.add_argument('--global_state_dim', type=int, default=150)
    parser.add_argument('--personal_state_dim', type=int, default=150)
...
if __name__ == '__main__':
    ...
    for seed in [1, 11, 111, 1111, 11111]:
        ...
        lf = open('logs/dialoguernn_meld_logs.txt', 'a')
        ...
        rf = open('results/dialoguernn_meld_results.txt', 'a')
