...
def main(args):
    ...
    trainset = dgcn.MELDDataset(data["train"], args.batch_size)
    devset = dgcn.MELDDataset(data["dev"], args.batch_size)
    testset = dgcn.MELDDataset(data["test"], args.batch_size)

    log.info("Building model...")
    model_file = "./save/meld_model.pt"
...
if __name__ == "__main__":
    ...
    for seed in seed_list:
      args.seed = seed
      # print args into logs.
      log.info(args)
      # start train: five epoches average.
      main(args)
